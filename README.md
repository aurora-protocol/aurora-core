...
This is not a production VPN or circumvention client. The spec still requires independent cryptographic review, production Privacy Pass verification, production cover-origin deployment hardening, production platform packaging and device entitlements, external active-probe evaluation, and external DPI/classifier evaluation before production use.
