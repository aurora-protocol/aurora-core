...
- policy profiles, PAL scoring, PACE reference behavior, local config parsing, threat-safe logging wrappers, `auroractl`, the local proxy client, relay admission/exit gates, vector drift tests, and ops helpers.
