...
func capabilitiesReport(w io.Writer) {
	...
	fmt.Fprintln(w, "- Section 9 wire scalar, opaque, vector, and struct encoding with opaque8/16/24 boundary test coverage, vector element-count boundary coverage, reserved enum rejection coverage, and bootstrap critical extension rejection coverage")
