...
func TestUDPFlowDemuxIsFlowIDAuthoritative(t *testing.T) {
	...
	if !bytes.Equal(local.ConfirmedDNSAnswerSetHash, fb(0xcc, 48)) || local.ConfirmedTTLSeconds != 60 || local.ConfirmedResolutionSource != protocol.UDPResolutionClientSuppliedIP {
